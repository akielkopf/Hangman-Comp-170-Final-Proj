...
namespace IntroCS
{
  /// File I/O functions to help find files and folders when they may be in more
  /// than one path.
  public class FIO
  {
    ...
    // GetLocation chunk 
    /// Return a directory conaining the filename, if it exists. Otherwise
    /// return null.
    ...
    // GetPath chunk 
    /// Find a directory containing the filename and return the full file path,
    ...
    // OpenWriter chunk 
    /// Join the location directory and filename; open and return a StreamWriter
    /// to the file.
